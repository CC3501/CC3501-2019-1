# coding=utf-8
"""
Daniel Calderon / Diego Donoso, CC3501, 2019-1
...
if __name__ == "__main__":
    ...
    void main()
    {
        float color = fract(sin(position2.r * 129.898 / 800 + position2.g * 782.33 / 600)*43758.5453123) / 4;
        outColor = vec4(0, 0, 0, 1.0f);
        outColor.x += clamp(fragColor.x + color, 0, 1);
        outColor.y += clamp(fragColor.y + color, 0, 1);
        outColor.z += clamp(fragColor.z + color, 0, 1);
    }
    """
